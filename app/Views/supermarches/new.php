...
<head>
  ...
  <title>Ajouter un supermarché — Miel Arovia</title>
...
<main class="main-wrapper">
  <div class="breadcrumb-bar"><a href="/supermarches">Supermarchés</a> <span>›</span> Ajouter un supermarché</div>
  <div class="page-header">
    <div class="page-title-wrap">
      <h1 class="page-title">Ajouter un supermarché</h1>
  ...
  <div class="content-card" style="max-width: 760px;">
    ...
    <form action="/supermarches" method="post">
      <?= csrf_field() ?>
      <div class="mb-3">
