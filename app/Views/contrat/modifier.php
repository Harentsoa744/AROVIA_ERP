...
<div class="carte carte-formulaire">
    <form action="<?= base_url('contrat/update/' . $contrat['id']) ?>" method="post">
        ...
        <div class="actions-formulaire">
            ...
            <a href="<?= base_url('contrat/detail/' . $contrat['id']) ?>" class="bouton bouton-secondaire">Annuler</a>
        </div>
    </form>
</div>
